define("dojox/charting/themes/CustomClaro", ["../Theme", "dojox/gfx/gradutils", "./common"], function(Theme, gradutils, themes){
    // created by Tom Trenka

    var g = Theme.generateGradient,
        defaultFill = {type: "linear", space: "shape", x1: 0, y1: 0, x2: 0, y2: 100};

    themes.CustomClaro = new Theme({
        chart: {
            // fill: {
            //  type: "linear",
        ...
        axis:{
            ...
            tick: { // used as a foundation for all ticks
                ...
                fontColor: "#444444"                                // color of labels
            }
        },
        series: {
        ...
        seriesThemes: [
            {fill: g(defaultFill, "#FF0000", "#3a99f2")},
    ...
    themes.CustomClaro.next = function(elementType, mixin, doPost){
    ...
    themes.CustomClaro.post = function(theme, elementType){
